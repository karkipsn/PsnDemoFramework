#
#  Be sure to run `pod spec lint PsnDemoFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Poshan" => "poshan@inficare.net" }
  # Or just: spec.author    = "Poshan"
  # spec.authors            = { "Poshan" => "poshan@inficare.net" }
  # spec.social_media_url   = "https://twitter.com/Poshan"
